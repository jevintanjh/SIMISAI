...
- 3 vertical market columns: Enterprise, Consumer, Retail
- Growth trajectory chart (2025-2030)

### Content:
**Title**: "$50B+ Market, 3 Immediate Revenue Streams"

**Total Addressable Market (TAM)**: $50B+ Global
- **Enterprise Training & Support**: $10B+ (APAC: $2B+)
  - Technical training, remote assistance, QA inspection
- **Consumer Smart Home/IoT**: $150B+ global (APAC: $30B+)
  - Product assembly, device setup, troubleshooting
- **Retail Technology**: $25B+ global
  - In-store product discovery, post-purchase support

**Serviceable Addressable Market (SAM)**: $5B+ (Southeast Asia + initial enterprise)
**Serviceable Obtainable Market (SOM)**: $250M (Year 3 target across 3 verticals)

**Why Southeast Asia First**:
- 680M population, rapid digital transformation
- Manufacturing hub (enterprise training demand)
- E-commerce growth (consumer/retail opportunity)

### Recommended Speech:
> "We're addressing a $50 billion market across three verticals. First, enterprise: The corporate training and remote support market is $10 billion globally, $2 billion in Asia-Pacific. Think factory training, field technician support, quality assurance. Second, consumer: The smart home and IoT market is $150 billion globally. We help people assemble IKEA furniture, set up their Wi-Fi routers, troubleshoot their coffee machines. Third, retail: A $25 billion market where we provide in-store product information and post-purchase support. Our serviceable addressable market in Southeast Asia is $5 billion, with a Year 3 target of $250 million across all three verticals."

**Key Message**: Multiple large markets, faster to monetize than medical
...
### Content:
**Title**: "Multiple Revenue Streams, 75%+ Gross Margins"

**Revenue Streams**:
1. **B2B Enterprise SaaS** ($2K-$10K/month per customer)
   - Manufacturing: Technical training and QA inspection
   - Field Services: Remote assistance and troubleshooting
   - Logistics: Warehouse operations guidance

2. **B2B White-Label Licensing** ($50K-$200K annual + usage fees)
   - Consumer electronics brands (e.g., Philips, Sonos)
   - Furniture/home goods (e.g., IKEA)
   - Appliance manufacturers (e.g., Bosch, Electrolux)

3. **B2B2C Platform Fees** (Revenue share: 10-20%)
   - Retail chains (Home Depot, Best Buy equivalents in SEA)
   - E-commerce platforms (Shopee, Lazada)
   - Smart home ecosystems

**Financial Projections**:
- **Year 1**: $300K (enterprise pilots + 2 white-label deals)
- **Year 2**: $3M (10 enterprise customers + 5 licensing deals)
...
## SLIDE 7: GO-TO-MARKET STRATEGY (30 seconds)

### Visual:
- 3-phase timeline (Months 0-6, 6-12, 12-24)
- Partnership logos/categories
- Geographic expansion map

### Content:
**Title**: "Phased Approach: Enterprise First, Consumer Second, Medical Third"

**Phase 1 (Months 0-6): Enterprise Validation**
- Target: 3-5 manufacturing/logistics pilot customers in Singapore
- Channels: Direct B2B sales, Singapore manufacturing associations
- Goal: Prove ROI (30%+ reduction in training costs, 50%+ faster technician dispatch)

**Phase 2 (Months 6-12): Consumer Partnerships**
- Target: 2-3 white-label partnerships (electronics, furniture, appliances)
- Channels: Brand partnerships, co-marketing
- Goal: 100K+ end users, case studies for scaling

**Phase 3 (Months 12-24): Scale + Medical Expansion**
- Geographic: Thailand, Indonesia, Vietnam expansion
- Verticals: Add retail, begin medical regulatory pathway
- Goal: 500K+ users, $3M+ ARR

**Distribution Channels**:
- Enterprise: Direct sales + system integrators
- Consumer: Brand partnerships + e-commerce platforms
- Medical: Hospital networks + insurance (Phase 3)

### Recommended Speech:
> "Our go-to-market is a three-phase strategy. Phase 1, months zero to six: Enterprise validation. We target 3 to 5 manufacturing or logistics companies in Singapore, proving we can reduce training costs by 30% and cut technician dispatch time in half. Phase 2, months 6 to 12: Consumer partnerships. We sign 2 to 3 white-label deals with electronics or furniture brands, reaching 100,000-plus end users and building case studies. Phase 3, months 12 to 24: We scale across Southeast Asia—Thailand, Indonesia, Vietnam—and expand into retail. We also begin our medical regulatory pathway now that we've proven commercial traction. This approach prioritizes fast revenue over slow regulatory approvals."

**Key Message**: Enterprise first = fastest revenue, medical later = maximum TAM
...
## SLIDE 9: TRACTION & ROADMAP (30 seconds)

### Visual:
- Timeline with milestones (checkmarks for completed, targets for upcoming)
- Pilot partner logos/descriptions
...
- **1 white-label partnership**: Consumer electronics brand (co-marketing)
- **User milestone**: 1,000 enterprise users, 10,000 consumer end-users
- **Revenue milestone**: $100K+ ARR from pilot contracts
...
- **Medical pathway initiated**: Singapore HSA submission (Class A/B)
- **User milestone**: 100K+ active users
...
### Risk Mitigation:
1. **Diversified revenue**: 3 verticals (enterprise, consumer, retail) reduce single-market risk
2. **Phased approach**: Fast commercial revenue validates model before medical regulatory timeline
3. **Multiple markets**: Southeast Asia expansion (5 countries) reduces geographic concentration
4. **High margins**: 75%+ gross margins provide profitability buffer

---

## APPENDIX: CHART & GRAPHIC SPECIFICATIONS

### Slide 2: Problem Illustration
**Type**: 3-panel side-by-side comparison
- Panel 1: Factory worker with confused expression, complex machinery in background, overlay text "$8B wasted annually on training"
- Panel 2: Consumer surrounded by product parts and manual, frustrated expression, overlay text "30% return rate"
- Panel 3: Retail customer holding phone in electronics store, overlay text "40% abandon purchases"

### Slide 5: TAM/SAM/SOM Visualization
**Type**: Concentric circles with annotations
- Outer circle: "$50B+ Total Addressable Market (Enterprise $10B, Consumer $150B, Retail $25B)"
- Middle circle: "$5B Serviceable Addressable Market (Southeast Asia + initial enterprise)"
- Inner circle: "$250M Serviceable Obtainable Market (Year 3 target)"

### Slide 6: Revenue Projections Chart
**Type**: Bar chart with stacked segments
- X-axis: Year 1, Year 2, Year 3
- Y-axis: Revenue ($ millions)
- Segments: Enterprise (blue), White-label (green), Platform fees (orange)
- Year 1: $300K total | Year 2: $3M total | Year 3: $12M total

### Slide 8: Competitive Positioning Matrix
**Type**: 2x2 matrix with competitor logos
- X-axis: "Single Language" (left) → "Multilingual 5+ Languages" (right)
- Y-axis: "Text Instructions" (bottom) → "CV + AI Guidance" (top)
- Top-right quadrant: SIMISAI logo (large, highlighted)
- Other quadrants: Competitor logos (Vuforia, WorkRamp, brand apps, etc.)

### Slide 10: Use of Funds Pie Chart
**Type**: Pie chart with 4 segments
- 40% Engineering (blue): $320K-$480K
- 30% Go-to-Market (green): $240K-$360K
- 20% Operations (orange): $160K-$240K
- 10% Contingency (gray): $80K-$120K
