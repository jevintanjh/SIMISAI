...
const CLUSTER_ARN = 'arn:aws:rds:us-east-1:710743745504:cluster:simisai-production-db';
const SECRET_ARN = 'arn:aws:secretsmanager:us-east-1:710743745504:secret:simisai-production-db-secret';
...
exports.handler = async (event) => {
    try {
        ...
        await executeSQL(initialDataSQL);
